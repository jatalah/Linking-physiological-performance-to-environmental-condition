...
setwd("C:/Users/rebeccamc/OneDrive - Cawthron/General - Environmental Health Measures for Open Ocean Aquaculture/Objective 3/Data analysis/Obj3_analysis/Field data")
#Read the Excel file
...
# Define full path
output_path <- "C:/Users/rebeccamc/OneDrive - Cawthron/General - Environmental Health Measures for Open Ocean Aquaculture/Objective 3/Data analysis/Obj3_analysis/Field data/results/Brachiopods/correlation_groups_B.xlsx"
...
correlation_network_plot_B_field<-ggraph(g_tidy, layout = "fr") +
  geom_edge_link(alpha = 0.5) +
  geom_node_point(aes(color = cluster), size = 5) +
  geom_node_text(aes(label = name), repel = TRUE, size = 3) +
  theme_void() +
  labs(title = "Highly Correlated Variable Groups (Brachiopods) (r > 0.90)")

ggsave("results/Brachiopods/correlation_network_plot_B_field.svg", plot = correlation_network_plot_B_field, width = 10, height = 8, dpi = 300, bg="white")
...
write_xlsx(unclustered_vars_df,
           "C:/Users/rebeccamc/OneDrive - Cawthron/General - Environmental Health Measures for Open Ocean Aquaculture/Objective 3/Data analysis/Obj3_analysis/Field data/results/Brachiopods/unclustered_variables_B.xlsx"
)
...
# Save to Excel
write_xlsx(best_vars_df, "C:/Users/rebeccamc/OneDrive - Cawthron/General - Environmental Health Measures for Open Ocean Aquaculture/Objective 3/Data analysis/Obj3_analysis/Field data/results/Brachiopods/best_vars_comparison.xlsx")
