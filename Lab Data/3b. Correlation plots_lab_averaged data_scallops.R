...
#Read the Excel file
# data <- read_excel("data/processed/combined_median_prevalence_2.xlsx") # this one wouldn't open
data <- read_csv("data/processed/combined_median_prevalence_2.csv") # assuming is the same as above

variables_to_keep <- c(
  "treatment_group",
  "species",
  "bc_grade_scale_median",
  "dev_score_scale_median",
  "he_level_scale_median",
  "c14_0_myristic_acid_DG_median",
  "c14_0_myristic_acid_Gonad_median",
  "c14_0_myristic_acid_Non-gonadal_median",
  "c16_0_palmitic_acid_DG_median",
  "c16_0_palmitic_acid_Gonad_median",
  "c16_1_palmitoleic_acid_DG_median",
  "c16_1_palmitoleic_acid_Gonad_median",
  "c18_0_stearic_acid_DG_median",
  "c18_0_stearic_acid_Gonad_median",
  "c18_0_stearic_acid_Non-gonadal_median",
  "c18_1n9c_oleic_acid_DG_median",
  "c18_1n9c_oleic_acid_Gonad_median",
  "c18_1n9c_oleic_acid_Mantle_median",
  "c18_1n9c_oleic_acid_Non-gonadal_median",
  "c18_2n6c_linoleic_acid_DG_median",
  "c18_2n6c_linoleic_acid_Gonad_median",
  "c18_2n6c_linoleic_acid_Non-gonadal_median",
  "c18_3n3_alpha_linolenic_acid_ala_DG_median",
  "c18_3n3_alpha_linolenic_acid_ala_Gonad_median",
  "c18_3n3_alpha_linolenic_acid_ala_Non-gonadal_median",
  "c18_4n3_stearidonic_acid_sda_DG_median",
  "c18_4n3_stearidonic_acid_sda_Gonad_median",
  "c18_4n3_stearidonic_acid_sda_Non-gonadal_median",
  "c20_0_arachidic_acid_DG_median",
  "c20_0_arachidic_acid_Gonad_median",
  "c20_0_arachidic_acid_Non-gonadal_median",
  "c20_1_gadoleic_acid_DG_median",
  "c20_1_gadoleic_acid_Gonad_median",
  "c20_1_gadoleic_acid_Non-gonadal_median",
  "c20_2_eicosadienoic_acid_DG_median",
  "c20_2_eicosadienoic_acid_Gonad_median",
  "c20_2_eicosadienoic_acid_Non-gonadal_median",
  "c20_4n6_arachidonic_acid_aa_DG_median",
  "c20_4n6_arachidonic_acid_aa_Gonad_median",
  "c20_4n6_arachidonic_acid_aa_Non-gonadal_median",
  "c20_5n3_eicosapentaenoic_acid_DG_median",
  "c20_5n3_eicosapentaenoic_acid_Gonad_median",
  "c20_5n3_eicosapentaenoic_acid_Mantle_median",
  "c20_5n3_eicosapentaenoic_acid_Non-gonadal_median",
  "c22_5n3_docosapentaenoic_acid_dpa_DG_median",
  "c22_5n3_docosapentaenoic_acid_dpa_Gonad_median",
  "c22_5n3_docosapentaenoic_acid_dpa_Non-gonadal_median",
  "c22_6n3_docosahexaenoic_acid_dha_DG_median",
  "c22_6n3_docosahexaenoic_acid_dha_Gonad_median",
  "c22_6n3_docosahexaenoic_acid_dha_Mantle_median",
  "c22_6n3_docosahexaenoic_acid_dha_Non-gonadal_median",
  "sfa_DG_median",
  "sfa_Gonad_median",
  "sfa_Mantle_median",
  "sfa_Non-gonadal_median",
  "mufa_DG_median",
  "mufa_Gonad_median",
  "mufa_Mantle_median",
  "mufa_Non-gonadal_median",
  "pufa_DG_median",
  "pufa_Gonad_median",
  "pufa_Mantle_median",
  "pufa_Non-gonadal_median",
  "omega_3_DG_median",
  "omega_3_Gonad_median",
  "omega_3_Mantle_median",
  "omega_3_Non-gonadal_median",
  "omega_6_DG_median",
  "omega_6_Gonad_median",
  "omega_6_Mantle_median",
  "omega_6_Non-gonadal_median",
  "percent_fat_DG_median",
  "percent_fat_Gonad_median",
  "percent_fat_Mantle_median",
  "percent_fat_Non-gonadal_median",
  "mean_teac_median",
  "mda_nmoles_mg_of_protein_r1_median",
  "mda_nmoles_mg_of_protein_r2_median",
  "vo2_per_g_6wks_median",
  "vo2_per_g_12wks_median",
  "isocitrate_dehydrogenase_idh_median",
  "aldehyde_dehydrogenase_median",
  "glutathione_reductase_median",
  "glutathione_peroxidase_median",
  "acetyl_co_a_c_acetyltransferase_acat_median",
  "fatty_acid_synthase_fas_median",
  "cathepsin_b_median",
  "cathepsin_l_median",
  "cathepsin_d_median",
  "enoyl_co_a_hydratase_median",
  "glutathione_transferase_median",
  ...
  "aifm1_apoptosis_inducing_factor_1_median",
  "pcna_proliferating_cell_nuclear_antigen_median",
  "toll_like_receptor_1_median",
  "tnf_ligand_superfamily_tnfsf_member_15_median",
  "sodium_calcium_exchanger_slc8a_median",
  "spectrin_alpha_median",
  "tubulin_alpha_tuba_median",
  "cytochrome_p450_cyp_family_1_subfamily_a1_median",
  "cytochrome_p450_cyp_family_1_subfamily_b1_median",
  "cytochrome_p450_cyp_family_2_subfamily_j_median",
  "solute_carrier_family_43_slc43a3_median",
  "coup_transcription_factor_1_median",
  "nuclear_receptor_subfamily_1_group_d_member_3_median",
  "hspa4_70k_da_a_co_chaperone_for_hsp70_median",
  "hspa5_bi_p_median",
  "suppressor_of_tumorigenicity_protein_13_st13_median",
  "ube2a_ubiquitin_conjugating_enzyme_e2_a_median",
  "apex1_ap_endonuclease_1_median",
  "mbd4_methyl_cp_g_binding_domain_protein_4_median",
  "hmgb1_high_mobility_group_protein_b1_median",
  "sodium_dependent_multivitamin_transporter_slc5a6_median",
  "sodium_dependent_phosphate_cotransporters_slc34a_mfs_transporter_median",
  "copper_transporter_slc31a1_median",
  "sodium_hydrogen_exchanger_slc9a10_median",
  "mitochondrial_folate_transporter_slc25a32_median",
  "birc2_baculoviral_iap_repeat_containing_protein_2_3_median",
  "cytochrome_family_3_subfamily_a4_median",
  "membrane_transport_protein_xk_median",
  "tn_fs_neuroblastoma_suppressor_of_tumorigenicity_1_nbl1_median",
  "dna_endonuclease_rbbp8_median",
  "donson_protein_downstream_neighbour_of_son_median",
  "gill_congestion_p_a_prevalence",
  "gill_elo_t1_p_a_prevalence",
  "gill_vacuolation_p_a_prevalence",
  "gut_f_he_p_a_prevalence",
  "gut_bc_p_a_prevalence",
  "gut_vacuolisation_p_a_prevalence",
  "apicomlexan_p_a_prevalence",
  "mantle_epithilial_elo_p_a_prevalence",
  "dg_and_gi_elo_p_a_prevalence",
  "dg_thinning_p_a_prevalence",
  "trematodes_p_a_prevalence",
  "new_parasites_p_a_prevalence",
  "gill_elo_p_a_prevalence",
  "paravortex_p_a_prevalence",
  "dg_atrophy_p_a_prevalence",
  "dg_elo_p_a_prevalence",
  "apx_p_a_prevalence",
  "apicomplexa_p_a_prevalence",
  "dg_luminal_space_open_p_a_prevalence",
  "gut_epi_atrophy_p_a_prevalence",
  "dg_bc_p_a_prevalence",
...
subset_cor_matrix[abs(subset_cor_matrix) < 0.70] <- NA
...
# Define full path
output_path <- "C:/Users/rebeccamc/OneDrive - Cawthron/General - Environmental Health Measures for Open Ocean Aquaculture/Objective 3/Data analysis/Obj3_analysis/Lab data/results/Scallops/correlation_groups_S.xlsx"
...
correlation_network_plot_S_lab<-ggraph(g_tidy, layout = "fr") +
  geom_edge_link(alpha = 0.5) +
  geom_node_point(aes(color = cluster), size = 5) +
  geom_node_text(aes(label = name), repel = TRUE, size = 3) +
  theme_void() +
  labs(title = "Scallops (lab experiment) - Highly Correlated Variable Groups (r > 0.95)")

ggsave("results/Scallops/correlation_network_plot_S_lab.svg", plot = correlation_network_plot_S_lab, width = 10, height = 8, dpi = 300, bg="white")
...
write_xlsx(unclustered_vars_df,
           "C:/Users/rebeccamc/OneDrive - Cawthron/General - Environmental Health Measures for Open Ocean Aquaculture/Objective 3/Data analysis/Obj3_analysis/Lab data/results/Scallops/unclustered_variables_S.xlsx"
)
...
# Save to Excel
write_xlsx(best_vars_df, "results/Scallops/best_vars_comparison_S.xlsx")
...
# Save to Excel
write_xlsx(p_matrix_df, "results/p_value_matrix.xlsx")
