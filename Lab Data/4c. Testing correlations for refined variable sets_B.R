...
variables_to_keep <- c("treatment_group", "species", "omega_3_Gonad_median",
...
file_path <- "C:/Users/rebeccamc/OneDrive - Cawthron/General - Environmental Health Measures for Open Ocean Aquaculture/Objective 3/Data analysis/Obj3_analysis/Lab data/results/Brachiopods/correlation_plot_B_2nd iteration.png"
...
# Define the file path 
file_path <- "C:/Users/rebeccamc/OneDrive - Cawthron/General - Environmental Health Measures for Open Ocean Aquaculture/Objective 3/Data analysis/Obj3_analysis/Lab data/results/Brachiopods/cluster_plot_B_2nd iteration.png"
